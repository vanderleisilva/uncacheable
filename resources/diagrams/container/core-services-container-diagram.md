...
- See [Container Diagram](container-diagram.md) for full system overview including GenAI Platform
...
- See [ADR-002: Microservices Architecture](../../../Architecture-Decision-Records/002-microservices-architecture.md)
- See [ADR-003: Event-Driven Backbone](../../../Architecture-Decision-Records/003-event-driven-backbone.md)
- See [ADR-004: Core Services Decomposition](../../../Architecture-Decision-Records/004-core-services-decomposition.md) - **Justification for this diagram's decisions**
